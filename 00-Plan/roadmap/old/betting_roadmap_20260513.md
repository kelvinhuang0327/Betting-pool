...
> **Superseded notice — 2026-05-15 CTO update:** Use `00-BettingPlan/roadmap/betting_roadmap_20260515_mlb_product_plan.md` as the current roadmap. The current directive makes `/Users/kelvin/Kelvin-WorkSpace/Betting-pool` the long-term single canonical repo and treats `Betting-pool-p13` as a source worktree to merge back, not a permanent canonical repo. v7 also reorders execution around MLB betting recommendations and strategy simulation optimization.
