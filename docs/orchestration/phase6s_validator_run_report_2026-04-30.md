...
**Valid real model output rows (all gates pass)**: 14
...
| `data/derived/model_outputs_6s_future_2026-04-30.jsonl` | ✅ | 26,767 B | Real contract target — **MISSING** |
...
|---|:---:|---:|:---:|:---:|---:|---|
| `data/derived/model_outputs_2026-04-29.jsonl` | ✅ | 14 | ✅ | ✅ | 14 | `MISSING_REAL_MODEL_OUTPUT_FILE` |
