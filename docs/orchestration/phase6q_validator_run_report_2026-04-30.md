...
**Valid real model output rows (all gates pass)**: 30
...
| `data/derived/model_outputs_6q_dry_run_2026-04-30.jsonl` | ✅ | 49,820 B | Real contract target — **MISSING** |
...
|---|:---:|---:|:---:|:---:|---:|---|
| `data/derived/model_outputs_2026-04-29.jsonl` | ✅ | 30 | ✅ | ✅ | 30 | `MISSING_REAL_MODEL_OUTPUT_FILE` |
...
**`READY_FOR_MODEL_OUTPUT_ADAPTER`**
