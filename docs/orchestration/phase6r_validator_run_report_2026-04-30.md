...
**Valid real model output rows (all gates pass)**: 10
...
| `data/derived/model_outputs_6r_future_2026-04-30.jsonl` | ✅ | 16,848 B | Real contract target — **MISSING** |
...
|---|:---:|---:|:---:|:---:|---:|---|
| `data/derived/model_outputs_2026-04-29.jsonl` | ✅ | 10 | ✅ | ✅ | 10 | `MISSING_REAL_MODEL_OUTPUT_FILE` |
